...
Paste a URL from YouTube, X/Twitter, TikTok, Instagram, Facebook, or Threads. The app downloads the media (including Instagram carousels) and optionally runs transcription on it. Downloaded files can be shared or saved directly to Photos.
